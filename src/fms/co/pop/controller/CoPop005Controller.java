 ...
 */
@Controller
public class CoPop005Controller {
...
//	private CoPop004Service coPop003Service;
    ...
    private static final Logger log = LoggerFactory.getLogger(CoPop005Controller.class);
     ...
     * @throws Exception
     */     
     @RequestMapping(value="/fms/co/pop/CoPop005.do")
