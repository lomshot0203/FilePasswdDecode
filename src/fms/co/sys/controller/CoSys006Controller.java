...
/**
 * @Class Name : CoSys006Controller.java
 * @Description : CoSys006Controller class
...
@Controller
public class CoSys006Controller {
     ...
     * @throws Exception
     */   
     @RequestMapping(value="/fms/co/sys/CoSys006.do")
     public String list(HttpServletRequest request, HttpServletResponse response) throws Exception {
         return "fms/co/sys/CoSys006";
     }
 	 ...
 	 * @throws Exception
 	 */
	@RequestMapping(value = "/fms/co/sys/CoSys006SelectMenuCreatManagList.do")
	public void selectMenuCreatManagList(HttpServletRequest request, HttpServletResponse response) throws Exception {
		/* 파라미터 */
		...
		/* 결과 리스트 반환*/
		List<?> list = menuCreateManageService.selectMenuCreatManagUsefulList(searchVO); //사용가능한 (스프링시큐리티 권한을 제외한) 목록 조회
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/fms/co/sys/CoSys006SaveMenuCreatManag.do")
	public void saveMenuCreatManag(HttpServletRequest request, HttpServletResponse response) throws Exception {
		/* 변수선언 */
		int succesCnt=0;
		String strMsg = "";
		HashMap map;
