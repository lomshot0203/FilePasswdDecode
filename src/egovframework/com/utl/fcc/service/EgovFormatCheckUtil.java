...
public class EgovFormatCheckUtil {
    ...
    /**
     * <p>XXX - XXX- XXXX 형식의 휴대전화번호 앞, 중간, 뒤 문자열 3개 입력 받아 유요한 휴대전화번호형식인지 검사.</p>
     * 
     * 
     * @param   휴대전화번호 문자열,(3개)
     * @return  유효한 휴대전화번호 형식인지 여부 (True/False)
     */
    ...
    /**
     * <p>XXXXXXXXXX 형식의 휴대전화번호 문자열 3개 입력 받아 유요한 휴대전화번호형식인지 검사.</p>
     * 
     * 
     * @param   휴대전화번호 문자열(1개)
     * @return  유효한 휴대전화번호 형식인지 여부 (True/False)
