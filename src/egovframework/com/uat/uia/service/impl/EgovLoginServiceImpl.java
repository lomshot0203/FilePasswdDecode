...
public class EgovLoginServiceImpl extends EgovAbstractServiceImpl implements EgovLoginService {
	...
	public LoginVO actionLoginIdCheck(LoginVO vo) throws Exception {
    	...
    	// 1. 아이디 체크
    	LoginVO loginVO = loginDAO.actionLoginIdCheck(vo);
    ...
    public LoginVO updateFail(LoginVO vo) throws Exception {
    	...
    	LoginVO loginVO = loginDAO.updateFail(vo);
    ...
    public LoginVO updateFailNull(LoginVO vo) throws Exception {
    	...
    	LoginVO loginVO = loginDAO.updateFailNull(vo);
	...
	public String findLastPwdChgTime(LoginVO vo) throws Exception {
		return loginDAO.findLastPwdChgTime(vo);
	}
}
