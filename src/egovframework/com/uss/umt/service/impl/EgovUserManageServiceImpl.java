...
public class EgovUserManageServiceImpl extends EgovAbstractServiceImpl implements EgovUserManageService {
	...
	public List<?> selectUserList2(UserDefaultVO userSearchVO) {
	    List<?> result = userManageDAO.selectUserList2(userSearchVO);
	    return result;
	}
	 ...
	 */
	@Override
	public void cancelFailUser(UserManageVO userManageVO) throws Exception {
		userManageDAO.cancelFailUser(userManageVO);
	}
