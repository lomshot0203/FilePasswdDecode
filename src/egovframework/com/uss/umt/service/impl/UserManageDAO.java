...
public class UserManageDAO extends EgovComAbstractDAO {
    ...
    public void deleteUser(String delId){
    	delete("userManageDAO.deleteUserDetails_S", delId); //FK 삭제
    ...
    public String insertUser(UserManageVO userManageVO){
    	...
    	userManageVO.setEmplNo(user.getId());
     ...
     * @return List 업무사용자 목록정보
     */
    public List<?> selectUserList2(UserDefaultVO userSearchVO){
        return list("userManageDAO.selectUserList_S2", userSearchVO);
    }
    ...
    /**
     * 화면에 조회된 사용자의 비밀번호 5회 오류 시간을 초기화 한다.
     * @param userManageVO 업무사용자 수정정보
     */
    public void cancelFailUser(UserManageVO userManageVO){
        update("userManageDAO.cancelFailUser",userManageVO);
    }
