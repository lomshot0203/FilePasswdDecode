...
public class AuthorManageDAO extends EgovComAbstractDAO {
    ...
    public void deleteAuthor(AuthorManage authorManage) throws Exception {
    	delete("authorManageDAO.comtnmenucreatdtls_fk", authorManage);
	 ...
	 */
    @SuppressWarnings("unchecked")
	public List<AuthorManageVO> selectAuthorUsefulList(AuthorManageVO authorManageVO) throws Exception {
        return (List<AuthorManageVO>) list("authorManageDAO.selectAuthorUsefulList", authorManageVO);
    }    
}
