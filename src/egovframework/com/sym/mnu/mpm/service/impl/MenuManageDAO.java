...
public class MenuManageDAO extends EgovComAbstractDAO {
	 ...
	 * @exception Exception
	 */
	public String selectLastTime(MenuManageVO vo) throws Exception{
		return (String) select("menuManageDAO.selectLastTime", vo);
	}
    ...
    public List<CommonMenuVO> selectMainMenuLeftV2(MenuManageVO vo) throws Exception{
        return (List<CommonMenuVO>) list("menuManageDAO.selectMainMenuLeftV2", vo);
    }
	/**
