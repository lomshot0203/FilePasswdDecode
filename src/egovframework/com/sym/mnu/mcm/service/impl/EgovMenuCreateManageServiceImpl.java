...
public class EgovMenuCreateManageServiceImpl extends EgovAbstractServiceImpl implements EgovMenuCreateManageService {
	...
	public List<?> selectMenuCreatManagUsefulList(ComDefaultVO vo) throws Exception {
		return menuCreateManageDAO.selectMenuCreatManagUsefulList(vo);
	}
	 ...
	 * @exception Exception
	 */
	public int selectMenuCreatManagUsefulTotCnt(ComDefaultVO vo) throws Exception {
		return menuCreateManageDAO.selectMenuCreatManagUsefulTotCnt(vo);
	}
