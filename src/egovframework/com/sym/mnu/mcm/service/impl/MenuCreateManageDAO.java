 ...
 *  2015.04.09     c          사용가능한 (스프링시큐리티 권한을 제외한) 목록 조회
 *
 * </pre>
 */
...
public class MenuCreateManageDAO extends EgovComAbstractDAO {
	...
	/**
	 * 사용 가능한 메뉴생성관리 내역을 조회
	 * @param vo ComDefaultVO
	 * @return List
	 * @exception Exception
	 */
	public List<?> selectMenuCreatManagUsefulList(ComDefaultVO vo) throws Exception{
		return list("menuManageDAO.selectMenuCreatManageUsefulList_D", vo);
	}

	/**
	 * 사용 가능한 메뉴생성관리 총건수를 조회한다.
	 * @param vo ComDefaultVO
	 * @return int
	 * @exception Exception
	 */
    public int selectMenuCreatManagUsefulTotCnt(ComDefaultVO vo) {
        return (Integer)select("menuManageDAO.selectMenuCreatManageUsefulTotCnt_S", vo);
    }
