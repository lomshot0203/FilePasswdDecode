...
public interface EgovMenuCreateManageService {
	...
	/**
	 * 사용 가능한 메뉴생성관리 목록을 조회
	 * @param vo ComDefaultVO
	 * @return List
	 * @exception Exception
	 */
	List<?> selectMenuCreatManagUsefulList(ComDefaultVO vo) throws Exception;
	 ...
	 * @exception Exception
	 */
	int selectMenuCreatManagUsefulTotCnt(ComDefaultVO vo) throws Exception;
