...
public class CmmnDetailCodeManageDAO extends EgovComAbstractDAO {
     ...
     * @throws Exception
     */
    public List<?> selectCmmnDetailCodeListFMS(CmmnDetailCodeVO searchVO) throws Exception {
        return list("CmmnDetailCodeManageDAO.selectCmmnDetailCodeListFMS", searchVO);
    }
