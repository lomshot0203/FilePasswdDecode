...
public class CmmnCode implements Serializable {
    ...
    public String getMappingDc1() {
		return mappingDc1;
	}

	public void setMappingDc1(String mappingDc1) {
		this.mappingDc1 = mappingDc1;
	}

	public String getMappingDc2() {
		return mappingDc2;
	}

	public void setMappingDc2(String mappingDc2) {
		this.mappingDc2 = mappingDc2;
	}

	public String getMappingDc3() {
		return mappingDc3;
	}

	public void setMappingDc3(String mappingDc3) {
		this.mappingDc3 = mappingDc3;
	}

	private String mappingDc1 = "";
    private String mappingDc2 = "";
    private String mappingDc3 = "";
	/**
